...
- SceneLayers 这里定义领袖外交界面的背景层数，官方主要文明领袖写4，将他们外交界面背景4张图叠在一起，效果就是那种黑色遮罩效果，如果你需要这个效果就也写4，也可不要保持默认0不用定义就好，至于其他数值会怎么样本人未探索
<details><summary>InheritFrom详解</summary>
